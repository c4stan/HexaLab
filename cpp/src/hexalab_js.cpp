...
EMSCRIPTEN_BINDINGS(HexaLab) {
    ...
    class_<HexaLab::LowQualityView>("LowQualityView")
        .constructor<>()
        //.function("set_mesh",               &HexaLab::LowQualityView::set_mesh)
        .function("update",                 &HexaLab::LowQualityView::update)
        .function("get_low_quality_model",  &HexaLab::LowQualityView::get_low_quality_model)
        .function("get_hidden_model",       &HexaLab::LowQualityView::get_hidden_model)
